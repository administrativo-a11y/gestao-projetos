// Ícones SVG no estilo Lucide. Stroke 1.8, currentColor, sem fill por padrão.
// Tamanho padrão 14×14; passe `size` pra mudar.

const base = (children, size = 14) => ({
  width: size,
  height: size,
  viewBox: '0 0 24 24',
  fill: 'none',
...
const make = (paths) => ({ size = 14, ...rest } = {}) => (
  <svg {...base(paths, size)} {...rest} />
)
...
export const IconCircleDot = make(
  <>
    <circle cx="12" cy="12" r="9" />
...
// — Mapa de tipos de custom_field → ícone ————————————————————————
...
export const STANDARD_COLUMN_ICONS = {
  status: IconStatus,
  assignee: IconUser,
  due_date: IconCalendar,
  priority: IconFlag,
  last_comment: IconMessage,
